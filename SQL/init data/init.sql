...
INSERT [dbo].[t_structure] ([IDENTIFICATION], [APPELLATION], [STRUCTUREXML]) VALUES (N'07880c98-caf1-494c-9c32-b52e686f3084', N'简单流程', N'<workflow><start id="30" name="开始" layout="303 17 79 -7" category="start" cooperation="0"><transition name="提交部门助理审批" destination="32" layout="333,109 333,146" id="38"></transition></start><end id="31" name="结束" layout="300 32 364 -11" category="end" cooperation="0"><action id="Smartflow.BussinessService.WorkflowService.DefaultAction" name="DefaultAction"/></end><node id="32" name="部门助理" layout="243 115 146 1" category="node" cooperation="1"><transition name="提交部门经理审批" destination="33" layout="333,186 331,245" id="39"></transition><transition name="提交部门副经理" destination="34" layout="333,186 588,246" id="40"></transition><transition name="提交部门副经理2" destination="35" layout="333,186 130,244" id="41"></transition><actor id="2" name="xuq"/><actor id="1" name="chengderen"/><actor id="4" name="zhangsan"/></node><node id="33" name="部门经理" layout="241 115 245 17" category="node" cooperation="0"><group id="3" name="总经理"/><action id="Smartflow.BussinessService.WorkflowService.TestAction" name="TestAction"/><transition name="结束" destination="31" layout="331,285 330,334" id="42"></transition><transition name="退回到部门助理" destination="32" layout="421,265 476,266 477,166 423,166" id="43"><marker x="471" y="261" length="43"/><marker x="472" y="161" length="61"/></transition></node><node id="34" name="部门副经理" layout="498 88 246 8" category="node" cooperation="0"><transition name="结束" destination="31" layout="588,286 330,334" id="44"></transition></node><node id="35" name="部门副经理2" layout="40 108 244 11" category="node" cooperation="0"><group id="6" name="总经理秘书"/><group id="7" name="项目经理"/><transition name="结束" destination="31" layout="130,284 330,334" id="45"></transition></node></workflow>')
