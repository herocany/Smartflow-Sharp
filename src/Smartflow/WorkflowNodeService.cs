...
namespace Smartflow
{
    public class WorkflowNodeService : WorkflowInfrastructure, IWorkflowNodeService, IWorkflowPersistent<Element, Action<string, object>>, IWorkflowQuery<IList<Node>, string>, IWorkflowParse
    {
        ...
        protected WorkflowOrganizationService OrganizationService
        {

            get
            {
                return new WorkflowOrganizationService();
            }
        }
        ...
        protected WorkflowCarbonService CarbonService
        {
            get
            {

                return new WorkflowCarbonService();
            }
        }
        ...
        public Element Parse(XElement element)
        {
            ...
            node.Veto = attr == null ? String.Empty : "Smartflow.Components.VetoService";
        ...
        public List<Transition> GetExecuteTransition(Node entry)
        {
            ...
            {
                transitions.Add(Utils.CONST_BACK_TRANSITION);
            }
            return transitions;
        }
        ...
        {
            IList<Node> nodes = new List<Node>();
            IList<Node> entries = base.Connection.Query<Node>(ResourceManage.SQL_WORKFLOW_NODE_SELECT_1, new { InstanceID = instanceID }).ToList();
