...
namespace Smartflow.Internals
{
    internal partial class ResourceManage
    {
        ...
        public const string SQL_WORKFLOW_STRUCTURE_UPDATE = " UPDATE T_Structure SET StructName=@StructName,StructXml=@StructXml,Memo=@Memo,Status=@Status WHERE NID=@NID";
